...
from .views import get_votes_by_city, get_population_distribution, population_gender_distribution, fertility_rate_by_region, income_distribution
...
urlpatterns = [
    ...
    path('income_distribution/', income_distribution, name='income_distribution'),
]
